...
public class GestaoVeiculosApplication implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {/*O que vem a ser este Exception?*/
		...
		Condominio cond2 = new Condominio (2L, "Ilha do Sol", false, end1);
		...
		UnidadeHabitacional un1 =  new UnidadeHabitacional(1L, "Ap 5J", "3D", true);
		...
		Morador m3 = new Morador(3L, "celinamax", "cma@1790", false, false, "Celina Maximiano", "145.886.123-24", data,  listaTelefones, cond2,  unidades);
	    ...
	    AnimalEstimacao an2 = new AnimalEstimacao(2L, "Rex", "Beagle","PEQUENO", data, m3 );
